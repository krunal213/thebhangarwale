...
class PhoneNumberActivity4 extends AppCompatActivity
        implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {

    public static final String TAG = PhoneNumberActivity4.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phone_number_v4);
        ui = new PhoneNumberUi(findViewById(R.id.phone_number), "hi");
